...
class AppotaView extends Component {
    ...
    componentDidMount() {
        ...
        GoogleAnalytics.trackScreenView('ga_borrow_money_otp');
    }
    ...
    ConfirmOTP(otp) {
        ...
        Requests.Verify_transaction(access_token, this.props.transaction_id, otp, 'OTP')
            .then((data) => {
                ...
                GoogleAnalytics.trackEvent('ga_borrow_money', 'Confirm OTP');
                appsFlyer.trackEvent('af_borrow_money_otp', {}, () => { }, () => { });
                AppEventsLogger.logEvent('fb_borrow_money_otp', 1)
