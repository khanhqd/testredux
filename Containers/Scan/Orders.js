...
class Orders extends React.Component {
    ...
    confirmPayment() {
        ...
        Actions.merchant_receipt({
            ...
            sAmount: Utils.toDotString(parseInt(this.props.amount)),
    ...
    PaymentOrder() {
        ...
        TimerMixin.setTimeout(() => {
            RequestHelper.RequestPaymentOrder(access_token, this.props.phone, this.props.amount, this.state.message)
                .then((data) => {
                    ...
                    if (data.status == 200) {
                        ...
                        if (user_infor.pay_verify_method == 'NONE')
                            ...
                            Actions.qrcode_orders_otp({ transaction_id: trans.transaction_id })
                    }
                    else {
            ...
            <View {...this.props} style={[styles.container, styles.tabHome]}>
                ...
                <View style={styles.FormControl}>
                            ...
                            <View style={styles.FormControl_Profile}>
                                ...
                                <View style={styles.FormControl_Input_Form}>
                                    ...
                                    <TextInput
                                        ...
                                        value={Utils.toDotString(parseInt(this.props.amount)) + 'đ'}
                                        placeholderTextColor="#c7c7cd"
                                        autoCorrect={false}
                                        editable={false}
                                        style={styles.FormControl_Input_Field}
                    ...
                    <View style={styles.FormControl_Button}>
                        {renderIf(this.props.phone != '' && this.props.amount != '')(
